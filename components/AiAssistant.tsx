  ...
  return (
    <>
        ...
        <button 
            ...
            className={`
                fixed bottom-6 right-6 h-14 w-14 rounded-full bg-brand-600 text-white shadow-xl flex items-center justify-center transition-transform hover:scale-105 hover:bg-brand-500 z-40
        ...
        >
            ...
            <span className="absolute -top-1 -right-1 flex h-3 w-3">
              ...
              <span className="relative inline-flex rounded-full h-3 w-3 bg-pitch-500"></span>
            </span>
        </button>

        {/* Chat Interface */}
        <div className={`
            fixed bottom-6 right-6 w-[380px] h-[550px] bg-white rounded-2xl shadow-2xl border border-slate-200 z-50 flex flex-col transition-all duration-300 transform origin-bottom-right overflow-hidden
